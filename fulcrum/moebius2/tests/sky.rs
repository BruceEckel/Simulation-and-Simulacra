...
use moebius2::cloud::{ARCS_MAX, ARCS_MIN, INK_MAX, INK_MIN, Style};
use moebius2::game::Weather;
use moebius2::look::{LOOKS, Look};
use moebius2::sky::{MESAS, PICTURE_INK, SUN_RADIUS, SUN_RING, Slab, compose, rocks};
...
fn the_uniforms_land_where_the_shader_reads_them() {
    ...
    let sky = moebius2::cloud::Sky::at(500.0, style);
    ...
    // The two settings, and the one line weight that is not a setting.
