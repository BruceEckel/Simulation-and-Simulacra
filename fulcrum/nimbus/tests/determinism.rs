...
//! The weather is six numbers advanced on the fixed tick, and every one of them is a float
//! being integrated: the moment one of those integrations picks up the frame's wall-clock
//! delta instead of the fixed one, the sky stops being reproducible and the replay is worth
